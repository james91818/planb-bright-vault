    ...
    <div className="space-y-4">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            <CardTitle className="text-base font-display">Roles & Permissions</CardTitle>
            <CardDescription>Manage staff roles and access control</CardDescription>
          </div>
          <Button size="sm" onClick={() => setCreateOpen(true)}><Plus className="h-4 w-4 mr-1" /> New Role</Button>
        </CardHeader>
